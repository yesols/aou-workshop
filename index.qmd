...
- Students from other SHAMP programs or other academic units: email yesols@uidaho.edu and ncoombs@uidaho.edu


## Schedule

::: {.callout-note}
2026 workshop dates are TBD
:::

| Session | Date and Time | Topics Covered |
| :--- | :--- | :--- |
| **Session 1** | [Date], [Time] | • Introduction to cloud computing and Researcher Workbench<br>• Super-brief introduction to relational database structures and queries<br>• Selecting cohorts and building your dataset |
| **Session 2** | [Date], [Time] | • Introduction to R<br>• Working with dataframes in R<br>• Obtaining query results and data wrangling |
| **Session 3** | [Date], [Time] | • More data wrangling<br>• Exploratory data analysis<br>• Data visualization |
| **Session 4** | [Date], [Time] | • Performing statistical tests<br>• Fitting regression models |
...
For any questions and inquiries about the workshop, contact Yesol Sapozhnikov (email: yesols@uidaho.edu). For general inquiries regarding student-led projects in SHAMP, contact Nicholas Coombs (email: ncoombs@uidaho.edu). 
